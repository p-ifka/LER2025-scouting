...
| 8      | 16     | 3      | 3      | 3      | ... | 3   | 4        | 32       | 4        | 32       | ... |
| match# | team # | check1 | check2 | check3 | ... | END | act type | act time | act type | act time | ... |
> bottom row is the type of data, top row is the size in bits
